...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt20">
            <form class="form-inline" action="admin/company/addCompanyEquity.do" method="post">
            ...
            <table class="table table-bordered table-hover table-responsive">
                <tbody>
                 <tr>
                    ...
                    <td class="col-md-10">
                    <input type="text" class="laydate-icon form-control"   id="t1"  name="reportDate" style="width:130px;height:30px" 
                    value="${companyFinance.reportDate}"  onClick="laydate({elem: '#t1',istime: true, format: 'YYYY-MM-DD'})">
                    	<input type="hidden" name="stockId" value="${companyEquity.stockId}" />
                    </td>
                </tr>
                <tr>
                    <td class="col-md-2">切片日期</td>
                    <td class="col-md-10">
                    	<input type="text" class="laydate-icon form-control"   id="t2"  name="snapshotDay" style="width:130px;height:30px" 
                    	value="${companyFinance.snapshotDay}" onClick="laydate({elem: '#t2',istime: true, format: 'YYYYMMDD'})">
                    </td>
                </tr>
