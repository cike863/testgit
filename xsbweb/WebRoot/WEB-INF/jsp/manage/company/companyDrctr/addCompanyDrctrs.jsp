...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt20">
            <form class="form-inline" action="admin/company/addCompanyDrctr.do" method="post">
            ...
            <table class="table table-bordered table-hover table-responsive">
                <tbody>
                 <tr>
                    ...
                    <td class="col-md-10">
                    	<input type="text" class="form-control" name="dsmName" value="${companyDrctr.dsmName}" >
                ...
                <tr>
                    <td>类型</td>
                     <td>董事：<input type="radio" value="d"  name="dsmType" checked  />&nbsp;&nbsp;&nbsp;&nbsp;
							监事：<input type="radio" value="s" name="dsmType" />&nbsp;&nbsp;&nbsp;&nbsp;
							高管：<input type="radio" value="m" name="dsmType" /></td>
                </tr>
							<tr>
