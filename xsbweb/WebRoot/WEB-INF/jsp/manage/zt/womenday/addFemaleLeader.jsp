                ...
                <tbody>
                 <tr>
                    ...
                    <td class="col-md-10">
                   		...
                   		<input type="text" class="form-control" style=" width:90%" name="companyName" value="${femaleLeader.companyName}"  >
                   	</td>
                </tr>
                 <tr>
                    <td class="col-md-2">股票代码</td>
                    <td class="col-md-10"><input type="text" class="form-control" style=" width:90%" name="stockId" value="${femaleLeader.stockId}" ></td>
                </tr>
                <tr>
                    <td>候选人姓名</td>
                    <td>
                    	<input type="text" class="form-control"  name="leaderName" value="${femaleLeader.leaderName}"  >
                    	</td>
                </tr>
                <tr>
                    <td>得票数</td>
                 ...
                 <tr>
                    <td>任务头像存储路径</td>
                     	<td>
                     		...
                     		<img id="leaderPicPath" src="${femaleLeader.leaderPicPath}" height="100px" width="100px" >
                ...
                <tr>
                    <td>公司图标存储路径</td>
                     	<td>
                     		...
                     		<img id="companyPicPath" src="${femaleLeader.companyPicPath}" height="100px" width="100px" >
