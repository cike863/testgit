...
<script type="text/javascript">
	window.onload = function(){
		...
		if(${meetVideoRoomVO.handler !=''}){
			var select = $("#handler option");				 
			for(var i=0; i<select.length; i++){  
				//console.log(select[i].value);
		        if(select[i].value == '${meetVideoRoomVO.handler}'){
        ...
        <div class="col-md-12 mt20">
            ...
            <table class="table table-bordered table-hover table-responsive">
                <tbody>
                  <tr>
                    <td>视频直播预告名称</td>
                    <td><input type="text" class="form-control" value="${meetVideoRoomVO.confName }" name="confName" style=" width:90%;" ></td>
                </tr>
                <tr>
                    <td>视频直播预告网址</td>
                    <td><input type="text" class="form-control"  name="baseUrl" value="${meetVideoRoomVO.baseUrl}" style=" width:90%;" ></td>
                </tr>
                <tr>
                    <td>上线时间</td>
                     <td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>分享用主标题</td> 
                     <td><input type="text" class="form-control" value="${meetVideoRoomVO.meetTitle }" name="meetTitle" style=" width:90%;" ></td>
                </tr>
                 <tr>
                    <td>分享用副标题</td>
                     <td><input type="text" class="form-control" value="${meetVideoRoomVO.meetExTitle }" name="meetExTitle" style=" width:90%;" ></td>
                </tr>
                <tr>
                    <td>关联项目</td>
                     <td>
