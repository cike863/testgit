    ...
    <form action="admin/etlschedule/editEtlSchedule.do" name="etlForm" method="post">
    		<table style="width: 100%">
    			<tr>
    				...
    				<td style=" width:35%;"><input type="text" readonly="readonly" name="taskTable" value="${etlScheduleVO.taskTable }" required  class="input-xlarge"/><form:errors path="taskTable"></form:errors></td>
    			...
    			<tr>
    				...
    				<td>任务失效时间</td>
    				<td>
    					<input placeholder="请输入日期" class="laydate-icon" name="extireDate" id="extireDate" style="height:30px" 
    					value="${etlScheduleVO.extireDate}"  onClick="laydate({elem: '#extireDate',istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
    				</td>
    			</tr>
    			<tr>
    				<td>最后一次执行时间</td>
    				<td>
    					<input placeholder="请输入日期" class="laydate-icon" name="lastExecTime" id="lastExecTime" style="height:30px" 
    				...
    				<td>
    					<input placeholder="请输入日期" class="laydate-icon" name="nextExecTime" id="nextExecTime"style="height:30px" 
    					 value="${etlScheduleVO.nextExecTime}" onClick="laydate({elem: '#nextExecTime',istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
    				</td>
    			</tr>
    			<tr>
    				<td>etl数据源记录格式</td>
