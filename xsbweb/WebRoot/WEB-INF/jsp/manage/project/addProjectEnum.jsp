	...
	<div class="container-full">
		<div class="row">
			<div class="col-md-12 mt10">
				<form:form action="enum/addEnum.do"  name="enumForm" method="post" class="form-horizontal">
					<div class="form-group">
						<label class="col-md-1 control-label">字段完整名称</label>
						<div class="col-md-2">
							<input type="text" class="form-control" name="enumFullName" value="${enumVOList.enumFullName }" placeholder="请输入枚举全程名称" readonly="readonly"/><form:errors path="enumFullName"></form:errors>
						</div>
					</div>
					<%-- <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" name="enumDesc" value="${enumVOList.enumDesc }" placeholder="请输入项目行业"/><form:errors path="enumDesc"></form:errors>
						</div>
					</div>
					<%-- <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" name="enumDescCn" value="${enumVOList.enumDescCn }" placeholder="请输入顺序"/><form:errors path="enumGroupCode"></form:errors>
						</div>
					</div>
					<div class="row">
