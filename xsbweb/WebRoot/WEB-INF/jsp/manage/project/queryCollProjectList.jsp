        ...
        <div class="col-md-12 mt10">
            <form class="form-inline" action="admin/project" method="post"  name="confForm"><!--action="admin/project/serach?serachInformation="+information, name="confForm" method="post"-->
                ...
                <div class="input-group">
                	<span class="input-group-addon">集体编号</span>
                	<input type="text" class="form-control" id="prmtParentNo" name="prmtParentNo" value="${trsProject.prmtParentNo}" readonly="readonly" style=" width:80px;" >
                </div>
                <div class="input-group">
                ...
                <a href="admin/project/toAddForieProject.do?prmtParentNo=${trsProject.prmtParentNo}" role="button" class="btn btn-success">新建</a>
            </form>
        </div>
    </div>
    <div class="row">
	                		...
	                		<tr>
		                        ...
		                        <td>	
		                        	<c:if test="${project.projectNo ne '' }">
		                        		<a href="admin/project/lastEditDate.do?projectNo=${project.projectNo}&prmtParentNo=${trsProject.prmtParentNo}">置顶</a> |
		                        		...
		                        		| <a href="http://<%=hostName%>:8080/XSBmobile/road/detail/roadItems.do?IsRoadOrWbeview=1&projectNo=${project.projectNo}&objectType=project" target="_blank">预览</a>
		                        		</c:if>
		                        	</c:if>
		                    </tr>
	                	</c:forEach>
...
<!--</form>-->
 ...
 <script type="text/javascript" language="javascript">
	...
	function addNews(projectNo,projCpCode){
		...
		if(projCpCode<400000){
			projCpCode="";
		}
		window.location="admin/news/toAdminNews.do?projectNo="+projectNo+"&word="+projCpCode;	
	}
	/**function serach(){
