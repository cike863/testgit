...
public interface TrsProjectMapper {
	...
	public int getApplyProjectCustomerCounts(String objectNo)throws Exception;
	 ...
	 * @throws Exception
	 */
	public void deleteSignProjectByprojectNoArrs(String[] projectNoArrs)throws Exception;
	/**
	 * 一键还原排序
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public int batchDeleteApplyCustomer(Map<String, Object> param)throws Exception;

	public int getApplyProjectCountByStockId(String stockId)throws Exception;
