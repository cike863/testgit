...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt20">
            <form class="form-inline" action="admin/company/editCompanyFinance.do" method="post">
            ...
            <table class="table table-bordered table-hover table-responsive">
                ...
                <tr>
                    ...
                    <td class="col-md-10">
                    	<input type="text" class="form-control" name="attrName" value="${companyFinance.attrName}"  readonly="readonly">
