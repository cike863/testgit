	...
	<div class="container-full">
		<div class="row">
			<div class="col-md-12 mt10">
				<form:form action="admin/encyclopedias/addBaike.do"  name="form" method="post" class="form-horizontal">
					<!--  <div class="form-group">
						<label class="col-md-1 control-label">编号</label>
						<div class="col-md-2">
							<input placeholder="请输入编号" type="text" class="form-control" name="baikeId" value="${bk.baikeId }" ">
						</div>
					</div>-->
					<div class="form-group">
