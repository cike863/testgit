...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 mt20">
            <form class="form-inline" action="admin/company" method="post">
            ...
            <table class="table table-bordered table-hover table-responsive">
                ...
                <tr>
                    ...
                    <td class="col-md-10"><input type="text" class="form-control" style=" width:900px;" name="stockId" value="${company.stockId}" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="col-md-10"><input type="text" class="form-control" style=" width:900px;" name="totalEquity" value="${company.totalEquity}" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="col-md-10"><textarea rows="6" cols="100%">${company.historyShort}</textarea></td>
                </tr>
                <tr>
