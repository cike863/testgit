	...
	<div class="container-full">
		<div class="row">
			<div class="col-md-12 mt10">
				<form:form action="admin/customer/editCustomer.do"  name="customerForm" method="post" class="form-horizontal">
				   <input type="hidden" name="customerId" value="${customer.customerId }"/>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<input type="text" class="form-control" name="customerCases" value="${customer.customerCases }" />
								<input type="hidden" class="form-control" name="gzIndustry" value="${customer.gzIndustry }" /><form:errors path="gzIndustry"></form:errors>
							</div>
						</div>
					</div>
